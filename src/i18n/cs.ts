...
const parserCs: ParserCopy = {
  ...
  pricingTitle: 'Ceny',
  pricingRows: [
    { item: 'Věčná licence (jednorázový dar)', amount: '$3,000 USD', priceKey: 'perpetual' },
    { item: 'Balíčky upgradů — první rok', amount: 'Zahrnuto' },
    { item: 'Balíčky upgradů — po prvním roce', amount: '$1,500 / rok', priceKey: 'annual' },
  ],
  pricingNote:
...
export const cs: Dictionary = {
  ...
  tryDrawing: {
    ...
    barLoading: 'otevírání…',
    title: 'Otevřít výkres',
    body: 'Přetáhněte sem DWG nebo DXF. Parsování a vykreslení probíhá v této kartě, soubor se nenahrává.',
    open: 'Otevřít soubor',
    trust: 'Bez nahrání · bez serveru',
    privacyTitle: 'Výkres neopustí tento prohlížeč',
    privacyBody: 'Soubory nenahráváme ani neukládáme na servery. Parsování a vykreslení probíhá v této kartě.',
    verifySummary: 'Jak v DevTools ověřit, že se soubor nenahrává',
    verifyBody:
      'Během používání tohoto dema otevřete Nástroje pro vývojáře → Network. Samotný soubor DWG se k zpracování neodesílá na externí server.',
    dragHint: 'Pusťte pro otevření',
    caption: '.dwg · .dxf · parsování v prohlížeči · bez nahrání',
    captionOpen: 'lokálně · {name} · {size}',
  ...
  footer: {
    tagline: 'CAD infrastruktura s otevřeným zdrojovým kódem pro web.',
