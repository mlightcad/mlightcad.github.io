...
const parserEs: ParserCopy = {
  ...
  pricingRows: [
    { item: 'Licencia perpetua (donación única)', amount: '$3,000 USD', priceKey: 'perpetual' },
    { item: 'Paquetes de actualización — primer año', amount: 'Incluido' },
    { item: 'Paquetes de actualización — después del primer año', amount: '$1,500 / año', priceKey: 'annual' },
  ],
  pricingNote:
  ...
  buyPerpetualCta: 'Comprar licencia perpetua',
  buyAnnualCta: 'Comprar actualizaciones anuales',
  checkoutUnavailable:
    'El pago en línea no está disponible temporalmente. Escriba a support@mlightcad.com para completar la compra.',
  purchaseSuccess: 'Pago recibido. Le enviaremos por correo las instrucciones de acceso en breve.',
  ...
  trialForm: {
    ...
    error: 'No se pudo enviar la solicitud. Inténtelo de nuevo o escriba a support@mlightcad.com.',
...
export const es: Dictionary = {
  ...
  tryDrawing: {
    ...
    barLoading: 'abriendo…',
    title: 'Abrir un dibujo',
    body: 'Suelta un DWG o DXF aquí. Se analiza y se renderiza en esta pestaña, nunca se sube.',
    open: 'Abrir archivo',
    trust: 'Nunca se sube · sin servidor',
    privacyTitle: 'Tu dibujo no sale de este navegador',
    privacyBody: 'No subimos ni almacenamos tus archivos. El análisis y el renderizado ocurren en esta pestaña.',
    verifySummary: 'Cómo comprobar con DevTools que el archivo no se sube',
    verifyBody:
      'Abre Herramientas de desarrollador → Network mientras usas esta demo. El archivo DWG no se transmite a un servidor externo para su procesamiento.',
    dragHint: 'Suelta para abrir',
    caption: '.dwg · .dxf · analizado en el navegador · sin subir',
    captionOpen: 'local · {name} · {size}',
    statusLoading: 'Leyendo dibujo…',
    statusLoadingViewer: 'Cargando visor…',
    statusInit: 'Iniciando visor…',
    errorType: 'Elige un archivo DWG o DXF.',
    errorInit: 'No se pudo iniciar el visor. Recarga e inténtalo de nuevo.',
    errorOpen: 'No se pudo abrir {name}.',
    errorLicenseExpired:
      'No se pudo abrir {name}. El periodo de evaluación del convertidor DWG ha caducado.',
    errorLicenseInvalid:
      'No se pudo abrir {name}. La licencia del convertidor DWG falta o no es válida.',
    retry: 'Probar otro archivo',
    ...
    items: [
      {
        ...
        actions: [
          {
            label: 'Descripción de la arquitectura',
  ...
  resources: {
    ...
    links: [
      ...
      {
        name: 'Plugin iframe',
        desc: 'Incruste DWG/DXF en su sitio',
        href: '/iframe-plugin.html',
      },
      {
        name: 'Documentación de la API',
  ...
  footer: {
    tagline: 'Infraestructura CAD de código abierto para la web.',
