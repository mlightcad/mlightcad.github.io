...
const parserKo: ParserCopy = {
  ...
  pricingTitle: '가격',
  pricingRows: [
    { item: '영구 라이선스 (일회성 기부)', amount: '$3,000 USD', priceKey: 'perpetual' },
    { item: '업그레이드 패키지 — 첫해', amount: '포함' },
    { item: '업그레이드 패키지 — 첫해 이후', amount: '$1,500 / 년', priceKey: 'annual' },
  ],
  pricingNote:
...
export const ko: Dictionary = {
  ...
  tryDrawing: {
    ...
    barLoading: '여는 중…',
    title: '도면 열기',
    body: 'DWG 또는 DXF를 여기에 놓으세요. 이 탭에서 파싱·렌더링되며 업로드되지 않습니다.',
    open: '파일 열기',
    trust: '업로드 없음 · 서버 없음',
    privacyTitle: '도면은 이 브라우저를 떠나지 않습니다',
    privacyBody: '파일은 서버에 업로드되거나 저장되지 않습니다. 파싱과 렌더링은 이 탭에서 이루어집니다.',
    verifySummary: '개발자 도구로 파일이 업로드되지 않았는지 확인하기',
    verifyBody:
      '이 데모를 사용하는 동안 개발자 도구 → Network를 여세요. DWG 파일 자체가 외부 서버로 전송되지 않는 것을 확인할 수 있습니다.',
    dragHint: '놓아서 열기',
