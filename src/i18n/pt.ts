...
const parserPt: ParserCopy = {
  ...
  pricingTitle: 'Preços',
  pricingRows: [
    { item: 'Licença perpétua (doação única)', amount: '$3,000 USD', priceKey: 'perpetual' },
    { item: 'Pacotes de atualização — primeiro ano', amount: 'Incluído' },
    { item: 'Pacotes de atualização — após o primeiro ano', amount: '$1,500 / ano', priceKey: 'annual' },
  ],
  pricingNote:
...
export const pt: Dictionary = {
  ...
  tryDrawing: {
    ...
    body: 'Largue um DWG ou DXF aqui. É analisado e renderizado nesta aba, nunca enviado.',
    open: 'Abrir ficheiro',
    trust: 'Nunca enviado · sem servidor',
    privacyTitle: 'O seu desenho não sai deste navegador',
    privacyBody: 'Não enviamos nem armazenamos os seus ficheiros. A análise e a renderização ficam nesta aba.',
    verifySummary: 'Como verificar nas DevTools que o ficheiro não é enviado',
    verifyBody:
      'Abra as Ferramentas de programador → Network enquanto usa esta demo. O ficheiro DWG em si não é transmitido para um servidor externo para processamento.',
  ...
  resources: {
    ...
    links: [
      ...
      {
        name: 'Plugin iframe',
        desc: 'Incorporar DWG/DXF no seu site',
        href: '/iframe-plugin.html',
      },
      {
        name: 'Documentação da API',
  ...
  footer: {
    tagline: 'Infraestrutura CAD de código aberto para a web.',
