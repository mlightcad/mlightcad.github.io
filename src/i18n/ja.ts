...
const parserJa: ParserCopy = {
  ...
  pricingTitle: '価格',
  pricingRows: [
    { item: '永久ライセンス（一回限りの寄付）', amount: '$3,000 USD', priceKey: 'perpetual' },
    { item: 'アップグレードパッケージ — 初年度', amount: '含む' },
    { item: 'アップグレードパッケージ — 2年目以降', amount: '$1,500 / 年', priceKey: 'annual' },
  ],
  pricingNote:
...
export const ja: Dictionary = {
  ...
  tryDrawing: {
    ...
    barLoading: '開いています…',
    title: '図面を開く',
    body: 'DWG / DXF をここにドロップ。このタブ内で解析・描画され、アップロードされません。',
    open: 'ファイルを開く',
    trust: 'アップロードなし · サーバーなし',
    privacyTitle: '図面はこのブラウザから出ません',
    privacyBody: 'ファイルはサーバーにアップロードも保存もされません。解析と描画はこのタブ内で行います。',
    verifySummary: 'DevTools でファイルがアップロードされていないことを確認する',
    verifyBody:
      'このデモの使用中に開発者ツール → Network を開いてください。DWG ファイル自体が外部サーバーへ送信されていないことを確認できます。',
    dragHint: '離して開く',
